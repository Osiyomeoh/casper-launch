...
export default function TradePage() {
  ...
  async function handleSell() {
    ...
    try {
      ...
      // Step 1: User signs an authorization message — fires wallet popup to confirm intent.
      // (CasperWallet doesn't yet support signing Casper 2.0 transactions, so we use
      // signMessage for user authorization, then the agent submits on-chain.)
